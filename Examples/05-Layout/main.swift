...
/// Spacer pushing content
struct SpacerSection: View {
    var body: some View {
        VStack(spacing: 4) {
            Text("Spacer")
                .font(.headline)
...
WebBackend().run(LayoutApp.self)
#else
print("Layout app defined. No backend available on this platform.")
#endif
