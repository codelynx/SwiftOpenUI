...
| `toolbar` | Both | iOS 14 / macOS 11 / watchOS 7 / tvOS 14 / visionOS 1 | Current | Partial | `Sources/SwiftOpenUI/Modifiers/ToolbarModifier.swift` | Public surface exists, but only 1 overload(s) are present vs 4 in the curated reference families. \| GTK: header bar; Win32: nav header; Web: header right area |
