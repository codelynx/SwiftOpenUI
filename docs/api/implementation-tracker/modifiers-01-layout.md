...
<<<<<<< HEAD
| `ignoresSafeArea` | Both | iOS 14 / macOS 11 / watchOS 7 / tvOS 14 / visionOS 1 | Current | Partial | `Sources/SwiftOpenUI/Modifiers/SafeAreaModifiers.swift` | Core API + GTK4/Win32 passthrough; visible effect pending backend safe-area model |
...
<<<<<<< HEAD
| `safeAreaInset` | Both | iOS 15 / macOS 12 / watchOS 8 / tvOS 15 / visionOS 1 | Current | Partial | `Sources/SwiftOpenUI/Modifiers/SafeAreaModifiers.swift` | Core API + GTK4/Win32 reserved-space layout; vertical + horizontal edges, alignment, spacing |
