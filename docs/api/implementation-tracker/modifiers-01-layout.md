...
| `ignoresSafeArea` | Both | iOS 14 / macOS 11 / watchOS 7 / tvOS 14 / visionOS 1 | Current | Partial | `Sources/SwiftOpenUI/Modifiers/SafeAreaModifiers.swift` | Core API + Win32 passthrough; visible effect pending native safe-area reservation |
...
| `safeAreaInset` | Both | iOS 15 / macOS 12 / watchOS 8 / tvOS 15 / visionOS 1 | Current | Partial | `Sources/SwiftOpenUI/Modifiers/SafeAreaModifiers.swift` | Core API + Win32 layout reservation; vertical + horizontal edges, alignment, spacing |
