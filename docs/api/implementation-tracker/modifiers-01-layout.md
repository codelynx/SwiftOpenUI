...
| `ignoresSafeArea` | Both | iOS 14 / macOS 11 / watchOS 7 / tvOS 14 / visionOS 1 | Current | Implemented | `Sources/SwiftOpenUI/Modifiers/SafeAreaModifiers.swift` | Web: passthrough; visible effect pending safe-area model |
...
| `safeAreaInset` | Both | iOS 15 / macOS 12 / watchOS 8 / tvOS 15 / visionOS 1 | Current | Implemented | `Sources/SwiftOpenUI/Modifiers/SafeAreaModifiers.swift` | Web: flex layout reservation all edges; spacing + alignment |
