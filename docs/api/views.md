...
| `Image(decoded:width:height:format:)` | Displays an already-decoded in-memory pixel buffer (rgba8/bgra8, straight or premultiplied) — e.g. a PDF page or generated bitmap. GTK4 implemented; Win32/Web placeholder pending a platform pass. |
