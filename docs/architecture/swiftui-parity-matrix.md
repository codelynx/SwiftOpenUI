...
| .ignoresSafeArea() | Y | Y | - | - | ~ | - | Web: passthrough; visible effect pending safe-area model |
| .safeAreaInset() | Y | Y | - | - | ~ | - | Web: flex layout reservation all edges; spacing + alignment |
| .clipShape() | Y | - | - | - | - | - | |
