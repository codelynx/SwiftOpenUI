...
| .ignoresSafeArea() | Y | Y | - | ~ | - | - | Win32: passthrough; other backends pending |
| .safeAreaInset() | Y | Y | - | ~ | - | - | Win32: layout reservation all edges; other backends pending |
| .clipShape() | Y | - | - | - | - | - | |
